...
MANUAL_TREE = [
    ...
    """, [
        ...
        """, []),
        ("Mouse Shortcut Wheel", """
            <h3>Mouse Shortcut Wheel</h3>
            <p>wxReader includes a shortcut wheel for quick reading operations. It works in the main document view.</p>
            <p><b>To open the shortcut wheel:</b></p>
            <ol>
                <li>Move the mouse pointer over the document page.</li>
                <li>Press and hold the <b>right mouse button</b>.</li>
                <li>Move the pointer toward the command you want.</li>
                <li>Release the button to run that command.</li>
            </ol>
            <p>The wheel is designed after Blender-style pie menus. It lets you turn pages, change page layout, and adjust zoom without using the menu bar.</p>
            <p>Available commands include <b>Nav Up</b>, <b>Nav Down</b>, <b>Single Page</b>, <b>Double Page</b>, <b>Zoom In</b>, <b>Zoom Out</b>, <b>Fit Page</b>, and <b>Fit Width</b>.</p>
        """, []),
...
MANUAL_TREE_ZHSG = [
    ...
    """, [
        ...
        ("鼠标快捷轮盘", """
            <h3>鼠标快捷轮盘</h3>
            <p>wxReader 提供一个用于快速阅读操作的快捷轮盘。此功能可在主文档视图中使用。</p>
            <p><b>打开快捷轮盘的方法：</b></p>
            <ol>
                <li>将鼠标指针移到文档页面上。</li>
                <li>按住<b>鼠标右键</b>。</li>
            ...
            <p>此轮盘的设计参考了 Blender 风格的饼状菜单。你可以不使用菜单栏，直接进行翻页、切换页面布局以及调整缩放。</p>
            <p>可用命令包括<b>向上导航</b>、<b>向下导航</b>、<b>单页</b>、<b>双页</b>、<b>放大</b>、<b>缩小</b>、<b>适应页面</b>和<b>适应宽度</b>。</p>
        """, []),
        ("自定义快捷键", """
            <h3>编辑键盘快捷键</h3>
...
MANUAL_TREE_ZHTW = [
    ("簡介", """
        <h3>歡迎使用 wxReader</h3>
        <p>wxReader 是一款用於檢視文件與漫畫的程式，支援 PDF、ePub 以及壓縮封存檔（ZIP、CBZ）。目前尚未測試 Mobi 與 fb2 檔案。</p>
        <p>您可以使用左側的<b>目錄</b>列表來瀏覽本說明檔案。</p>
    """, []),

    ("介面", """
        <h3>使用介面</h3>
        <p>主視窗左側為側邊欄，右側為檢視區域。</p>
        <ul>
            <li><b>側邊欄：</b>顯示章節或檔案。按 <b>F9</b> 可隱藏或顯示側邊欄。</li>
            <li><b>主檢視：</b>顯示文件頁面。</li>
        </ul>
    """, [
        ("圖庫模式", """
            <h3>使用圖庫模式</h3>
            <p>圖庫模式會顯示目前資料夾中所有文件的縮圖。若要使用此模式，請按一下<b>檔案</b>，然後按一下<b>圖庫模式</b>。</p>
            <p>按一下縮圖即可開啟對應的檔案。</p>
        """, []),
        ("搜尋與大綱", """
            <h3>快速定位</h3>
            <p><b>大綱分頁</b></p>
            <p>此分頁會列出文件中的章節。按一下章節即可移至對應位置。</p>
            <p>如果檔案（例如 ZIP 或 CBZ）不包含章節，wxReader 會自動為您產生列表：</p>
            <ul>
                <li><b>小型檔案：</b>列出每一頁。</li>
                <li><b>大型檔案（超過 500 頁）：</b>每 10 頁列出一個項目。</li>
            </ul>
            <p><b>搜尋</b></p>
            <p>按 <b>Ctrl+F</b> 可搜尋文字。按一下結果即可移至對應頁面。</p>
        """, []),
        ("鍵盤快速鍵", """
            <h3>鍵盤快速鍵</h3>
            <p>您可以使用以下按鍵來控制程式：</p>
            <table border="1" cellpadding="5" cellspacing="0" width="100%">
                <tr style="background-color: #c0c0c0;"><th><b>要執行的動作…</b></th><th><b>請按…</b></th></tr>
                <tr><td>開啟檔案</td><td>Ctrl + O</td></tr>
                <tr><td>關閉檔案</td><td>Ctrl + W</td></tr>
                <tr><td>顯示/隱藏側邊欄</td><td>F9</td></tr>
                <tr><td>切換側邊欄分頁</td><td>F8</td></tr>
                <tr><td>全螢幕</td><td>F11</td></tr>
                <tr><td colspan="2"><b>變更檢視</b></td></tr>
                <tr><td>單頁</td><td>Ctrl + 1</td></tr>
                <tr><td>雙頁</td><td>Ctrl + 2</td></tr>
                <tr><td>符合頁寬</td><td>Ctrl + 3</td></tr>
                <tr><td>符合視窗</td><td>Ctrl + 4</td></tr>
                <tr><td>放大/縮小</td><td>Ctrl + (+) / (-)</td></tr>
                <tr><td colspan="2"><b>瀏覽頁面</b></td></tr>
                <tr><td>下一頁/上一頁</td><td>向右方向鍵 / 向左方向鍵</td></tr>
                <tr><td>移至指定頁面</td><td>Ctrl + G</td></tr>
                <tr><td>尋找文字</td><td>Ctrl + F</td></tr>
                <tr><td>檢視目錄</td><td>Ctrl + T</td></tr>
                <tr><td colspan="2"><b>工具</b></td></tr>
                <tr><td>複製文字</td><td>Ctrl + E</td></tr>
                <tr><td>儲存圖片</td><td>Ctrl + I</td></tr>
            </table>
        """, []),
        ("滑鼠快捷輪盤", """
            <h3>滑鼠快捷輪盤</h3>
            <p>wxReader 提供一個用於快速閱讀操作的快捷輪盤。此功能可在主文件檢視中使用。</p>
            <p><b>開啟快捷輪盤的方法：</b></p>
            <ol>
                <li>將滑鼠指標移到文件頁面上。</li>
                <li>按住<b>滑鼠右鍵</b>。</li>
            ...
            <p>此輪盤的設計參考了 Blender 風格的圓盤功能表。您可以不使用功能表列，直接進行翻頁、切換頁面配置以及調整縮放。</p>
            <p>可用命令包括<b>向上導覽</b>、<b>向下導覽</b>、<b>單頁</b>、<b>雙頁</b>、<b>放大</b>、<b>縮小</b>、<b>符合頁面</b>和<b>符合寬度</b>。</p>
        """, []),
        ("自訂快速鍵", """
            <h3>編輯鍵盤快速鍵</h3>
            <p>您可以將鍵盤快速鍵變更為您偏好的設定。</p>
            <p><b>自訂快速鍵的方法：</b></p>
            <ol>
                <li>按一下<b>檔案</b>功能表。</li>
                <li>按一下<b>偏好設定</b>。</li>
                <li>找到要變更的動作。</li>
                <li>按兩下快速鍵欄位，然後按下要設定的新按鍵組合。</li>
                <li>按一下<b>儲存</b>以儲存設定。</li>
            </ol>
            <p>自訂快速鍵將會儲存，並在您每次開啟程式時自動生效。</p>
        """, []),
    ]),

    ("檔案與資料夾", """
        <h3>管理您的檔案</h3>
        <p>本節說明如何管理您的圖書收藏與資料夾。</p>
    """, [
        ("檔案瀏覽器與資料夾列表", """
            <h3>瀏覽資料夾</h3>
            <p>側邊欄中的分頁可協助您瀏覽所有檔案與資料夾。</p>
            <p>使用方法：</p>
            <ol>
                <li>檢視左側的分頁。</li>
                <li>在<b>檔案導覽</b>分頁中瀏覽，或在<b>資料夾列表</b>分頁中排序並列出資料夾內的所有檔案。</li>
                <li>按兩下任意檔案即可開啟。</li>
            </ol>
            <p>側邊欄頂端的工具列提供了常用操作的快速按鈕。</p>
        """, []),
        ("最近開啟的檔案", """
            <h3>開啟以前使用過的檔案</h3>
            <p>「最近開啟的檔案」對話方塊會記錄您開啟過的檔案。</p>
            <p><b>開啟「最近開啟的檔案」對話方塊的方法：</b></p>
            <ol>
                <li>在功能表中按一下<b>檔案</b>。</li>
                <li>按一下<b>最近開啟的檔案</b>。</li>
            </ol>
            <p>按一下清單中的任意檔案即可立即開啟。</p>
        """, []),
        ("密碼管理", """
            <h3>管理密碼</h3>
            <p>若您有多個受密碼保護的檔案，「密碼編輯器」對話方塊可協助您整理密碼。</p>
            <p><b>開啟「密碼編輯器」的方法：</b></p>
            <ol>
                <li>在功能表中按一下<b>檔案</b>。</li>
                <li>按一下<b>編輯密碼簿</b>。</li>
            </ol>
            <p>您可以在此新增、編輯或刪除密碼清單中的密碼。這比直接編輯文字檔更為方便。</p>
            <p style="border:  1px solid #000; padding: 10px; background-color: #ffffcc;">
                <b>警告：</b><br>
                <code>pswd.txt</code> 是純文字檔案。任何使用此電腦的人都可以開啟並讀取您的密碼。<b>請勿</b>在公用或共用電腦上使用此功能。
            </p>
        """, []),
    ]),
    ...
    ("閱讀體驗", """
        <h3>閱讀文件</h3>
        <p>您可以變更頁面在螢幕上的顯示方式。</p>
    """, [
        ("頁面配置", """
            <h3>頁面配置</h3>
            <p>按一下<b>檢視</b>功能表以選取配置：</p>
            <ul>
                <li><b>單頁檢視：</b>一次顯示一頁。向下捲動以檢視更多內容。</li>
                <li><b>雙頁檢視：</b>並排顯示兩頁，類似書本。</li>
            </ul>
            <p><b>翻頁方向</b></p>
            <p>您可以變更閱讀方向。英文書籍請使用<b>從左到右</b>；漫畫請使用<b>從右到左</b>。</p>
        """, []),
        ("自訂檢視", """
            <h3>自訂檢視</h3>
            <p><b>邊界與間距</b></p>
            <p>按一下<b>檢視</b>，然後按一下<b>設定邊界與間距</b>，以變更頁面周圍的空白區域。</p>
            <p><b>背景顏色</b></p>
            <p>按一下<b>檢視</b>，然後按一下<b>背景顏色</b>，以選取頁面後方區域的新顏色。</p>
        """, []),
        ("外部控制器", """
            <h3>使用外部程式控制翻頁</h3>
            <p>若要使用此功能，請按一下<b>導覽</b>，然後按一下<b>外部控制</b>。</p>
            <p>使用 wxReader 底部狀態列中的連接埠 (Port) 和權杖 (Token) 進行連線。</p>
            <p><b>通訊</b></p>
            <p>將 UDP 封包傳送到 127.0.0.1 的作用中連接埠，並使用訊息格式 <b>TOKEN|COMMAND</b>（例如 Ab1!23|NEXT）。<br>可用的 COMMAND：\"NEXT\" 或 \"PREV\"。</p>
        """, []),
    ]),
    ...
    ("工具與處理", None, [
        ("內容擷取", """
            <h3>複製內容</h3>
            <p><b>擷取文字（Ctrl+E）</b></p>
            <p>此操作會開啟一個視窗，顯示目前頁面的文字。您可以將其複製到剪貼簿。</p>
            <p><b>擷取圖片（Ctrl+I）</b></p>
            <p>此操作會尋找目前頁面上的所有圖片。您可以將其儲存到電腦。</p>
        """, []),
        ("視覺效果", """
            <h3>使用視覺效果</h3>
            <p>您可以使用濾鏡來變更文件的外觀。這些效果由顯示卡執行。</p>
            <p>使用濾鏡的方法：</p>
            <ol>
                <li>按一下<b>處理</b>功能表。</li>
                <li>展開子資料夾。</li>
                <li>按一下效果名稱。</li>
            </ol>
            <p>效果會立即生效。若要關閉視覺效果，請在同一功能表中選取關閉選項。</p>
        """, []),
        ("渲染品質", """
            <h3>圖片縮放品質</h3>
            <p>此設定用於控制圖片在螢幕上縮放（放大或縮小）時的品質。<br>較耗時的渲染方式顯示效果未必更好，但在較舊的電腦上可能會變慢。</p>
            <p>若要變更設定，請按一下<b>檢視</b>功能表，移至<b>渲染品質</b>，然後按一下所需的設定。</p>
        """, []),
    ]),
    ...
    ("進階自訂", None, [
        ("自訂 GPU 著色器", """
            <h3>建立自訂效果</h3>
            <p>進階使用者可以透過撰寫著色器檔案來建立新效果。</p>
            <p><b>新增濾鏡的方法：</b></p>
            <ol>
                <li>開啟程式目錄中的 <code>filters</code> 資料夾。</li>
                <li>建立一個副檔名為 <code>.frag</code> 的文字檔。</li>
            </ol>
            <p>程式會傳遞以下 uniform 變數至您的著色器：</p>
            <table border="1" cellpadding="5" cellspacing="0" width="100%">
                <tr style="background-color: #c0c0c0;"><th><b>變數</b></th><th><b>類型</b></th><th><b>說明</b></th></tr>
                <tr><td><b>uTex</b></td><td>sampler2D</td><td>頁面影像。</td></tr>
                <tr><td><b>uResolution</b></td><td>vec2</td><td>螢幕大小（寬、高）。</td></tr>
                <tr><td><b>uTime</b></td><td>float</td><td>計時器，從 0 計數並循環至 1000。</td></tr>
                <tr><td><b>uSeed</b></td><td>float</td><td>隨機數。</td></tr>
                <tr><td><b>uStrength</b></td><td>float</td><td>強度設定。您可以在<b>處理-&gt;著色器設定</b>中使用「強度」滑桿進行調整。</td></tr>
            </table>
        """, []),
    ]),
    ...
    """, [
        ("修正跨頁錯位", """
            <h3>為什麼頁面出現在錯誤的一側？</h3>
            <p>在<b>雙頁檢視</b>中，第一頁可能應顯示在右側，但程式將其放在左側。</p>
            <p><b>解決方法：</b></p>
            <ol>
                <li>按一下<b>檢視</b>功能表。</li>
                <li>按一下<b>加入空白起始頁</b>。</li>
            </ol>
            <p>此操作會在開頭加入一個空白頁，從而將所有頁面推至正確的位置。</p>
        """, []),
        ("版本資訊", """
            <h3>我正在使用哪個版本？</h3>
            <p>若要查看 wxReader 的版本：</p>
            <ol>
                <li>在功能表中按一下<b>資訊</b>。</li>
                <li>按一下<b>關於</b>。</li>
            </ol>
            <p>此視窗會顯示版本號碼及程式的其他資訊。</p>
        """, []),
        ("檢查更新", """
            <h3>取得新功能與修正</h3>
            <p>wxReader 可以檢查是否有更新版本可用。</p>
            <p>若要手動檢查更新：</p>
            <ol>
                <li>在功能表中按一下<b>資訊</b>。</li>
                <li>按一下<b>檢查更新…</b>。</li>
            </ol>
            <p>從舊版本升級時，只需將包含所有使用者設定的 <b>wxReader.cfg</b> 和 <b>pswd.txt</b> 檔案複製到新版本資料夾中即可。所有 wxReader 發行版均為可攜式版本。</p>
        """, []),
    ])
]
...
MANUAL_TREE_ZHHK = [
    ("簡介", """
        <h3>歡迎使用 wxReader</h3>
        <p>wxReader 係一個用嚟檢視文件同漫畫嘅程式，支援 PDF、ePub 同壓縮封存檔案（ZIP、CBZ）。Mobi 同 fb2 檔案暫時未經測試。</p>
        <p>您可以使用左邊嘅<b>目錄</b>清單瀏覽本說明檔案。</p>
    """, []),

    ("介面", """
        <h3>使用介面</h3>
        <p>主視窗左邊係側邊欄，右邊係檢視區域。</p>
        <ul>
            <li><b>側邊欄：</b>顯示章節或檔案。按 <b>F9</b> 可以隱藏或顯示側邊欄。</li>
            <li><b>主檢視：</b>顯示文件頁面。</li>
        </ul>
    """, [
        ("圖庫模式", """
            <h3>使用圖庫模式</h3>
            <p>圖庫模式會顯示目前資料夾入面所有文件嘅縮圖。若要使用此模式，請按一下<b>檔案</b>，然後按一下<b>圖庫模式</b>。</p>
            <p>按一下縮圖即可開啟對應嘅檔案。</p>
        """, []),
        ("搜尋同大綱", """
            <h3>快速定位</h3>
            <p><b>大綱分頁</b></p>
            <p>此分頁會列出文件入面嘅章節。按一下章節即可移至對應位置。</p>
            <p>如果檔案（例如 ZIP 或 CBZ）唔包含章節，wxReader 會自動為您產生清單：</p>
            <ul>
                <li><b>小型檔案：</b>列出每一頁。</li>
                <li><b>大型檔案（超過 500 頁）：</b>每 10 頁列出一個項目。</li>
            </ul>
            <p><b>搜尋</b></p>
            <p>按 <b>Ctrl+F</b> 可以搜尋文字。按一下結果即可移至對應頁面。</p>
        """, []),
        ("鍵盤快速鍵", """
            <h3>鍵盤快速鍵</h3>
            <p>您可以使用以下按鍵控制程式：</p>
            <table border="1" cellpadding="5" cellspacing="0" width="100%">
                <tr style="background-color: #c0c0c0;"><th><b>要執行嘅動作…</b></th><th><b>請按…</b></th></tr>
                <tr><td>開啟檔案</td><td>Ctrl + O</td></tr>
                <tr><td>關閉檔案</td><td>Ctrl + W</td></tr>
                <tr><td>顯示/隱藏側邊欄</td><td>F9</td></tr>
                <tr><td>切換側邊欄分頁</td><td>F8</td></tr>
        ...
        ("滑鼠快捷輪盤", """
            <h3>滑鼠快捷輪盤</h3>
            <p>wxReader 提供一個用嚟快速閱讀操作嘅快捷輪盤。此功能可以喺主文件檢視入面使用。</p>
            <p><b>開啟快捷輪盤嘅方法：</b></p>
            <ol>
                <li>將滑鼠指標移到文件頁面上。</li>
                <li>按住<b>滑鼠右鍵</b>。</li>
            ...
            <p>此輪盤嘅設計參考咗 Blender 風格嘅圓盤功能表。您可以唔使用功能表列，直接進行翻頁、切換頁面配置以及調整縮放。</p>
            <p>可用命令包括<b>向上導覽</b>、<b>向下導覽</b>、<b>單頁</b>、<b>雙頁</b>、<b>放大</b>、<b>縮小</b>、<b>符合頁面</b>同<b>符合寬度</b>。</p>
        """, []),
        ("自訂快速鍵", """
            <h3>編輯鍵盤快速鍵</h3>
            <p>您可以將鍵盤快速鍵變更為您偏好嘅設定。</p>
            <p><b>自訂快速鍵嘅方法：</b></p>
            <ol>
                <li>按一下<b>檔案</b>功能表。</li>
                <li>按一下<b>偏好設定</b>。</li>
                <li>搵到要變更嘅動作。</li>
                <li>按兩下快速鍵欄位，然後按下要設定嘅新按鍵組合。</li>
                <li>按一下<b>儲存</b>以儲存設定。</li>
            </ol>
            <p>自訂快速鍵會儲存，並會喺您每次開啟程式時自動生效。</p>
        """, []),
    ]),

    ("檔案同資料夾", """
        <h3>管理您嘅檔案</h3>
        <p>本節說明如何管理您嘅圖書收藏同資料夾。</p>
    """, [
        ("檔案瀏覽器同資料夾清單", """
            <h3>瀏覽資料夾</h3>
            <p>側邊欄入面嘅分頁可以協助您瀏覽所有檔案同資料夾。</p>
            <p>使用方法：</p>
            <ol>
                <li>檢視左邊嘅分頁。</li>
                <li>喺<b>檔案導覽</b>分頁中瀏覽，或者喺<b>資料夾清單</b>分頁中排序並列出資料夾入面嘅所有檔案。</li>
                <li>按兩下任意檔案即可開啟。</li>
            </ol>
            <p>側邊欄頂端嘅工具列提供常用操作嘅快速按鈕。</p>
        """, []),
        ("最近開啟嘅檔案", """
            <h3>開啟以前使用過嘅檔案</h3>
            <p>「最近開啟嘅檔案」對話方塊會記錄您開啟過嘅檔案。</p>
            <p><b>開啟「最近開啟嘅檔案」對話方塊嘅方法：</b></p>
            <ol>
                <li>喺功能表入面按一下<b>檔案</b>。</li>
                <li>按一下<b>最近開啟嘅檔案</b>。</li>
            </ol>
            <p>按一下清單入面嘅任意檔案即可立即開啟。</p>
        """, []),
        ("密碼管理", """
            <h3>管理密碼</h3>
            <p>如果您有多個受密碼保護嘅檔案，「密碼編輯器」對話方塊可以協助您整理密碼。</p>
            <p><b>開啟「密碼編輯器」嘅方法：</b></p>
            <ol>
                <li>喺功能表入面按一下<b>檔案</b>。</li>
                <li>按一下<b>編輯密碼簿</b>。</li>
            </ol>
            <p>您可以喺呢度新增、編輯或刪除密碼清單入面嘅密碼。呢個方法比直接編輯文字檔更加方便。</p>
            <p style="border:  1px solid #000; padding: 10px; background-color: #ffffcc;">
                <b>警告：</b><br>
                <code>pswd.txt</code> 係純文字檔案。任何使用此電腦嘅人都可以開啟並讀取您嘅密碼。<b>請勿</b>喺公用或共用電腦上使用此功能。
            </p>
        """, []),
    ]),
    ...
    """, [
        ...
        ("自訂檢視", """
            <h3>自訂檢視</h3>
            <p><b>邊界同間距</b></p>
            <p>按一下<b>檢視</b>，然後按一下<b>設定邊界同間距</b>，以變更頁面周圍嘅空白區域。</p>
            <p><b>背景顏色</b></p>
            <p>按一下<b>檢視</b>，然後按一下<b>背景顏色</b>，以選取頁面後方區域嘅新顏色。</p>
        """, []),
        ("外部控制器", """
            <h3>使用外部程式控制翻頁</h3>
            <p>若要使用此功能，請按一下<b>導覽</b>，然後按一下<b>外部控制</b>。</p>
            <p>使用 wxReader 底部狀態列入面嘅連接埠 (Port) 同權杖 (Token) 進行連線。</p>
            <p><b>通訊</b></p>
            <p>將 UDP 封包傳送到 127.0.0.1 嘅作用中連接埠，並使用訊息格式 <b>TOKEN|COMMAND</b>（例如 Ab1!23|NEXT）。<br>可用嘅 COMMAND：\"NEXT\" 或 \"PREV\"。</p>
        """, []),
    ]),

    ("工具同處理", """
        <h3>工具同處理</h3>
        <p>本節說明如何擷取內容、使用視覺效果，以及調整圖片渲染品質。</p>
    """, [
        ("內容擷取", """
            <h3>複製內容</h3>
            <p><b>擷取文字（Ctrl+E）</b></p>
            <p>此操作會開啟一個視窗，顯示目前頁面嘅文字。您可以將其複製到剪貼簿。</p>
            <p><b>擷取圖片（Ctrl+I）</b></p>
            <p>此操作會尋找目前頁面上嘅所有圖片。您可以將其儲存到電腦。</p>
        """, []),
        ("視覺效果", """
            <h3>使用視覺效果</h3>
            <p>您可以使用濾鏡變更文件嘅外觀。呢啲效果由顯示卡執行。</p>
            <p>使用濾鏡嘅方法：</p>
            <ol>
                <li>按一下<b>處理</b>功能表。</li>
                <li>展開子資料夾。</li>
            ...
            <p>效果會立即生效。若要關閉視覺效果，請喺同一功能表中選取關閉選項。</p>
        """, []),
        ("渲染品質", """
            <h3>圖片縮放品質</h3>
            <p>此設定用於控制圖片喺螢幕上縮放（放大或縮小）時嘅品質。<br>較耗時嘅渲染方式顯示效果未必更好，但喺較舊嘅電腦上可能會變慢。</p>
            <p>若要變更設定，請按一下<b>檢視</b>功能表，移至<b>渲染品質</b>，然後按一下所需嘅設定。</p>
        """, []),
    ]),

    ("進階自訂", """
        <h3>進階自訂</h3>
        <p>本節適合需要自行加入進階視覺效果嘅使用者。</p>
    """, [
        ("自訂 GPU 著色器", """
            <h3>建立自訂效果</h3>
            <p>進階使用者可以透過撰寫著色器檔案建立新效果。</p>
            <p><b>新增濾鏡嘅方法：</b></p>
            <ol>
                <li>開啟程式目錄入面嘅 <code>filters</code> 資料夾。</li>
                <li>建立一個副檔名為 <code>.frag</code> 嘅文字檔。</li>
            </ol>
            <p>程式會傳遞以下 uniform 變數至您嘅著色器：</p>
            <table border="1" cellpadding="5" cellspacing="0" width="100%">
                <tr style="background-color: #c0c0c0;"><th><b>變數</b></th><th><b>類型</b></th><th><b>說明</b></th></tr>
                <tr><td><b>uTex</b></td><td>sampler2D</td><td>頁面影像。</td></tr>
                <tr><td><b>uResolution</b></td><td>vec2</td><td>螢幕大小（寬、高）。</td></tr>
                <tr><td><b>uTime</b></td><td>float</td><td>計時器，從 0 計數並循環至 1000。</td></tr>
                <tr><td><b>uSeed</b></td><td>float</td><td>隨機數。</td></tr>
                <tr><td><b>uStrength</b></td><td>float</td><td>強度設定。您可以喺<b>處理-&gt;著色器設定</b>中使用「強度」滑桿進行調整。</td></tr>
            </table>
        """, []),
    ]),
    ...
    """, [
        ("修正跨頁錯位", """
            <h3>點解頁面會出現喺錯誤嗰邊？</h3>
            <p>喺<b>雙頁檢視</b>入面，第一頁可能應該顯示喺右邊，但程式會將佢放喺左邊。</p>
            <p><b>解決方法：</b></p>
            <ol>
                <li>按一下<b>檢視</b>功能表。</li>
                <li>按一下<b>加入空白起始頁</b>。</li>
            </ol>
            <p>此操作會喺開頭加入一個空白頁，從而將所有頁面推至正確位置。</p>
        """, []),
        ("版本資訊", """
            <h3>我而家使用緊邊個版本？</h3>
            <p>若要查看 wxReader 嘅版本：</p>
            <ol>
                <li>喺功能表入面按一下<b>資訊</b>。</li>
                <li>按一下<b>關於</b>。</li>
            </ol>
            <p>此視窗會顯示版本號碼同程式嘅其他資訊。</p>
        """, []),
        ("檢查更新", """
            <h3>取得新功能同修正</h3>
            <p>wxReader 可以檢查是否有更新版本可用。</p>
            ...
            <p>從舊版本升級時，只需將包含所有使用者設定嘅 <b>wxReader.cfg</b> 同 <b>pswd.txt</b> 檔案複製到新版本資料夾中即可。所有 wxReader 發行版均為可攜式版本。</p>
        """, []),
    ])
]
...
MANUAL_TREE_JAJP = [
    ...
    """, [
        ...
        """, []),
        ("マウス ショートカット ホイール", """
            <h3>マウス ショートカット ホイール</h3>
            <p>wxReader には、読書中の操作をすばやく行うためのショートカット ホイールがあります。この機能は、メインのドキュメント表示エリアで使用できます。</p>
            <p><b>ショートカット ホイールを開くには:</b></p>
            <ol>
                <li>マウス ポインターをドキュメント ページの上に移動します。</li>
                <li><b>マウスの右ボタン</b>を押したままにします。</li>
                <li>実行したいコマンドの方向へポインターを移動します。</li>
                <li>ボタンを離すと、そのコマンドが実行されます。</li>
            </ol>
            <p>このホイールは、Blender 風のパイ メニューを参考にしています。メニュー バーを使わずに、ページ移動、ページ レイアウトの変更、ズーム調整を行うことができます。</p>
            <p>使用できるコマンドには、<b>上へ移動</b>、<b>下へ移動</b>、<b>単ページ</b>、<b>見開き</b>、<b>拡大</b>、<b>縮小</b>、<b>ページに合わせる</b>、<b>幅に合わせる</b>があります。</p>
        """, []),
        ("ショートカットのカスタマイズ", """
